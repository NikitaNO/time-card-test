...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
                ...
                if( $(this).hasClass('global') ) {
                    ...
                    if( optionsList.find('li:not(.optgroup)').filter(':not(.selected)').filter(':visible').length ) {
                        optionsList.find('li:not(.optgroup)').filter(':not(.selected)')
                            .filter(':visible').find('input[type="checkbox"]').trigger('selectedAllCheckBoxes');
                        instance.options.selectAllCheckBoxes();
                    }
                    // deselect everything
                    else {
                        optionsList.find('li:not(.optgroup).selected:visible input[type="checkbox"]').trigger('deselectedAllCheckBoxes');
                        instance.options.deselectAllCheckBoxes();
            ...
            optionsWrap.on('selectedAllCheckBoxes', 'input[type="checkbox"]', function(){
                $(this).closest( 'li' ).toggleClass( 'selected' );
            ...
            optionsWrap.on('deselectedAllCheckBoxes', 'input[type="checkbox"]', function(){
                $(this).closest( 'li' ).toggleClass( 'selected' );
